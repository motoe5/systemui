...
.method private dispatchAdditions(Ljava/util/List;Landroid/support/v7/util/ListUpdateCallback;III)V
    ...
    .local v4, "update$iterator":Ljava/util/Iterator;
    :goto_1
    ...
    .end local v4    # "update$iterator":Ljava/util/Iterator;
    :sswitch_1
    iget-object v5, p0, Landroid/support/v7/util/DiffUtil$DiffResult;->mNewItemStatuses:[I
...
.method public dispatchUpdatesTo(Landroid/support/v7/util/ListUpdateCallback;)V
    ...
    .line 709
    .local v10, "snake":Landroid/support/v7/util/DiffUtil$Snake;
    ...
    .line 696
    .end local v1    # "postponedUpdates":Ljava/util/List;, "Ljava/util/List<Landroid/support/v7/util/DiffUtil$PostponedUpdate;>;"
    .end local v2    # "batchingCallback":Landroid/support/v7/util/BatchingListUpdateCallback;
    .end local v3    # "endX":I
    .end local v6    # "endY":I
    .end local v7    # "i":I
    .end local v8    # "posNew":I
    .end local v9    # "posOld":I
    .end local v10    # "snake":Landroid/support/v7/util/DiffUtil$Snake;
    .end local v11    # "snakeIndex":I
    ...
    .line 726
    .restart local v1    # "postponedUpdates":Ljava/util/List;, "Ljava/util/List<Landroid/support/v7/util/DiffUtil$PostponedUpdate;>;"
    .restart local v3    # "endX":I
    .restart local v6    # "endY":I
    .restart local v7    # "i":I
    .restart local v8    # "posNew":I
    .restart local v9    # "posOld":I
    .restart local v10    # "snake":Landroid/support/v7/util/DiffUtil$Snake;
    .restart local v11    # "snakeIndex":I
    .restart local v12    # "snakeSize":I
    :cond_4
